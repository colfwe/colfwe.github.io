...
+ 破烂笔记本，不值得折腾
  ...
  我甚至因为tab键坏了，至今都还保持者在bash里面 ~C-i~ 来补全的行为
...
+ 打游戏同时心累了
  ...
  再加上我实在不想，每几天打开那台屏幕垃圾得很的笔记本，然后每隔几天就要pacman -Syu一下
  ...
  即既可以打游戏比如星露谷欧卡三角洲赛车游戏等等，又可以时不时看一下我个人的【打开linux就仅仅是为了emacs】的个人要求
...
#+begin_src sh
  ...
  # 我也是询问AI后，几乎绝望之后才知道的
  # 总结起来的意思是，让Weston(一个Wayland窗口管理器跑在X11上，或让Wayland协议跑XWayland应用)
...
其实这个方案的灵感，来自于 [[https://emacs-china.org/t/windows-dev-drive-emacs/29362][在 Windows 的开发人员驱动器 (Dev Drive) 中安装 Emacs「続」]]这里，下面是我个人的尝试。
...
*** 【个人暴论】WSL+WSLg只适合GUI应用，不太适合TUI应用
